                        ...
                        SDL_Scancode scancode)
{
    ...
    if (oldMask && oldMask != newMask) {
        SDL_SendKeyboardKey(SDL_RELEASED, (Uint32)(scancode), scancode);    // Urho3D: raw keyboard code
                      ...
                      unsigned int sided_device_dependent_mask)
{
    ...
    if (new_dep_mask && old_dep_mask != new_dep_mask) {
        SDL_SendKeyboardKey(SDL_PRESSED, (Uint32)(scancode), scancode);    // Urho3D: raw keyboard code
    } else {
                    ...
                    unsigned int right_device_dependent_mask)
{
    ...
    if ((device_dependent_mask & oldMods) == 0) {
         ...
         */
        SDL_SendKeyboardKey(SDL_RELEASED, (Uint32)(left_scancode), left_scancode);    // Urho3D: raw keyboard code
        return;
    }
    ...
    if ( left_device_dependent_mask & oldMods ) {
        SDL_SendKeyboardKey(SDL_RELEASED, (Uint32)(left_scancode), left_scancode);    // Urho3D
    }
               ...
               unsigned int oldMods, unsigned int newMods)
{
    ...
    if (oldMask != newMask) {
        SDL_SendKeyboardKey(SDL_PRESSED, (Uint32)(SDL_SCANCODE_CAPSLOCK), SDL_SCANCODE_CAPSLOCK);    // Urho3D
...
Cocoa_HandleKeyEvent(_THIS, NSEvent *event)
{
    ...
    case NSKeyDown:
        ...
        SDL_SendKeyboardKey(SDL_PRESSED, (Uint32)(code), code);    // Urho3D: raw keyboard code
#if 1
        ...
        break;
    case NSKeyUp:
        SDL_SendKeyboardKey(SDL_RELEASED, (Uint32)(code), code);    // Urho3D: raw keyboard code
        break;
    case NSFlagsChanged:
