...
X11_DispatchEvent(_THIS)
{
    ...
    */
...
#endif
            SDL_SendKeyboardKey(SDL_PRESSED, (Uint32)(keycode), videodata->key_layout[keycode]);    // Urho3D: raw keyboard code
#if 0
    ...
    case KeyRelease:{
            ...
            SDL_SendKeyboardKey(SDL_RELEASED, (Uint32)(keycode), videodata->key_layout[keycode]);    // Urho3D: raw keyboard code
        }
        break;
